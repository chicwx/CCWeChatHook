#line 1 "/Users/wangxiao/personal/iOS逆向/Demo/CCWeChat/CCWeChatDylib/Logos/CCWeChatDylib.xm"
...
#line 22 "/Users/wangxiao/personal/iOS逆向/Demo/CCWeChat/CCWeChatDylib/Logos/CCWeChatDylib.xm"
...
static BOOL _logos_method$_ungrouped$MicroMessengerAppDelegate$application$didFinishLaunchingWithOptions$(_LOGOS_SELF_TYPE_NORMAL MicroMessengerAppDelegate* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd, UIApplication * application, NSDictionary * launchOptions) {
    ...
    _logos_orig$_ungrouped$MicroMessengerAppDelegate$application$didFinishLaunchingWithOptions$(self, _cmd, application, launchOptions);
...
static void _logos_method$_ungrouped$MicroMessengerAppDelegate$flexClick(_LOGOS_SELF_TYPE_NORMAL MicroMessengerAppDelegate* _LOGOS_SELF_CONST __unused self, SEL __unused _cmd) {
    [[FLEXManager sharedManager] showExplorer];
}
