...
- (id)getTitleLableViewWithMaxWidth:(double)arg1 title:(id)arg2 { %log; id r = %orig; HBLogDebug(@" = %@", r); return r; }
- (id)getTitleLableViewWithMaxWidth:(double)arg1 title:(id)arg2 fontSize:(double)arg3 { %log; id r = %orig; HBLogDebug(@" = %@", r); return r; }
