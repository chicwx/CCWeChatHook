...
var __getWebGLContext__ = function(origin_ctx){
    ...
    var batchGL = {
        ...
        bufferData: function (a, b, c) {
            ...
            if(typeof b === 'number' && !isNaN(b))
            {
                ...
                var bufferId = origin_ctx.setArrayBuffer(b);
    ...
    bufferSubData: function(a, b,c){
        checkContextChange(this.ctxid, 1);
        var bufferId = origin_ctx.setArrayBuffer(c);
    ...
    getShaderSource: function (shader) {
        checkContextChange(this.ctxid, 1);
        commonstring = commonstring  + ';77,1,' + shader.id;
        return this.batchRender(true);
    },
    deleteProgram: function (program) {
        checkContextChange(this.ctxid, 1);
        commonstring = commonstring  + ';78,1,' + program.id;
        webglObjects.push(program);
    },
    deleteFramebuffer: function (framebuffer) {
        checkContextChange(this.ctxid, 1);
        commonstring = commonstring  + ';79,1,' + framebuffer.id;
        webglObjects.push(framebuffer);
    },
    deleteRenderbuffer: function (renderbuffer) {
        checkContextChange(this.ctxid, 1);
        commonstring = commonstring  + ';80,1,' + renderbuffer.id;
    ...
    readPixels: function (x, y, width, height, format, type, pixels) {
        ...
        //133
        this.batchRender(false);
        return origin_ctx.readPixels(x, y, width, height, format, type, pixels);
    },
