...
@class ForwardMessageLogicController, MMTableView, MMUILabel, NSString, UIImageView, UIView, WCTimeLineFooterView, WSFullVideoDragEducateView, WSVideoFlowTableViewCell, WSVideoFullScreenController, WSVideoModel, WSVideoTagInfo;

@interface WSVideoFlowViewController : WSVideoFlowBaseViewController <WSVideoFlowDataDelegate, UITableViewDelegate, UITableViewDataSource, tableViewDelegate, WSVideoFlowTableViewCellDelegate, MMRefreshTableFooterDelegate, UIViewControllerAnimatedTransitioning, WSVideoPlayerViewDelegate, WSFullVideoDragEducateViewDelegate>
{
    UIView *_navBarBkg;
    UIView *_headerView;
