...
@class EditImageAnimatedTextTool, EditImageDeleteBarView, EmoticonBoardView, EmoticonCameraReportObject, EmoticonCameraResultSetting, EmoticonEditTextInputView, EmoticonEmptyEditView, FSVideoInput, FilterManager, MMTimer, NSString, SightPreviewViewF3, UIButton, UIImageView;

@interface EmoticonCameraResultView : UIView <EmoticonBoardViewDelegate, BaseEmoticonViewDelegate, EditImageOperationDelegate, EditImageAnimatedDelegate, EmoticonEditTextInputDelegate, EmoticonTextAntiSpamCgiDelegate, MMTipsViewControllerDelegate, FSVideoInputDelegate>
{
