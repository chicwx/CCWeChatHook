...
@interface FavVideoDetailViewController : FavMMUIViewController <MMWebViewDelegate, UIAlertViewDelegate, INetworkStatusMgrExt, IFavoritesExt, FavForwardLogicDelegate, WCActionSheetDelegate>
{
