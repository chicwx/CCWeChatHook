...
@class CAGradientLayer, CContact, EnterpriseConnectorLogic, FixDocumentPresent, ForwardMessageLogicController, MMJSApiVerifyMgr, MMScrollActionSheet, MMTimer, MMTipsViewController, MMURLHandler, MMWebBottomToolBar, MMWebCustomLog, MMWebProgressBar, MMWebTransitionController, MMWebViewPerformance, MMWebViewPluginScheduler, MMWebViewPresetUI, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString, NSURLRequest, TipsView, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView, UIViewController, WCDeepLinkHandler, WKWebView<YYWebViewInterface>, WebViewA8KeyLogicImpl, WebViewJSLogicImpl, WebViewMenuCustomizeLogic, WebViewOAuthLogic, WebViewTimeProfileData;
...
@interface MMWebViewController : MMUIViewController <MMWebSearchViewDelegate, MMWebViewDelegate, MMScrollActionSheetDelegate, EnterpriseConnectorLogicDelegate, MMExposeViewControllerDelegate, H5GameScrollActionSheetDelegate, WCForceTouchPopProtocol, UIGestureRecognizerDelegate, IUiUtilExt, MMTipsViewControllerDelegate, ISysCallCheckExt, MMWebPopInteractiveTransitionDelegate, WCActionSheetDelegate, UIAlertViewDelegate, MMWebViewFontFloatViewDelegate, WebViewA8KeyLogicDelegate, WebViewJSLogicDelegate, UIScrollViewDelegate, MMJSApiVerifyMgrDelegate, ForwardMessageLogicDelegate, WCCommitViewResultDelegate, WXCustomWebViewControllerProtocol, YYWebViewDelegate>
{
    ...
    NSString *_preloadPageReportUrl;
