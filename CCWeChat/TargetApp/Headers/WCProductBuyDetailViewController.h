...
@interface WCProductBuyDetailViewController : WCBizBaseViewController <MMWebViewDelegate, IWCProductExt, WCProudctReceiptEditDelegate, IWCAddressGetAddressControlLogicExt, IWCPayControlLogicExt, UIAlertViewDelegate, IWCAddressControlLogic>
{
