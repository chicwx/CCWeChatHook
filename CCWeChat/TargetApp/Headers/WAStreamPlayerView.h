...
@class AVPlayerItemVideoOutput, MMProgressViewEx, MMUIButton, MMUILabel, MPVolumeView, NSString, UIButton, UIColor, UIImage, UIImageView, UILabel, WAScreenBrightnessStateView, WAVideoLayer, WAVideoPlayerCore, WCNetworkMediaSlider;
