...
@class CBaseContactInfoAssist, CContact, CContactVerifyLogic, CMessageWrap, FavClickStreamHelper, ForwardMessageLogicController, NSMutableDictionary, NSString, SendVerifyMsgLogicController;
