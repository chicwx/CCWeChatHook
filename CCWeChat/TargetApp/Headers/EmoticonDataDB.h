...
@class WCTMigrationDatabase, WCTTable;

@interface EmoticonDataDB : NSObject
{
    WCTMigrationDatabase *_m_emoticonDB;
...
@property(retain) WCTMigrationDatabase *m_emoticonDB; // @synthesize m_emoticonDB=_m_emoticonDB;
- (void).cxx_destruct;
...
- (id)GetEmoticonsOnProperty:(const struct WCTPropertyList *)arg1 Where:(const struct Expression *)arg2 orderBy:(const list_dda92e41 *)arg3 limit:(int)arg4;
- (void)ResetEmoticon;
