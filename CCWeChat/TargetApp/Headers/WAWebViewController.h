...
@class FixDocumentPresent, ForwardMessageLogicController, NSDictionary, NSMutableDictionary, NSMutableSet, NSString, NSURLRequest, UIImageView, UILongPressGestureRecognizer, UIScreenEdgePanGestureRecognizer, UIView, UIView<YYWebViewInterface>, WAAppActionSheet, WABaseInfoToast, WACacheVersionChecker, WAHTMLWebViewController, WAMenuPopInteractiveTransition, WANavLoadingLayer, WAWebErrorView, WAWebViewJSLogicImpl, WAWebViewMenuNavBarProperties, WAWebViewMutiFuncMenuView, WAWebViewPluginScheduler;

@interface WAWebViewController : MMUIViewController <WAAppActionSheetDelegate, MMTipsViewControllerDelegate, WCActionSheetDelegate, WAPopInteractiveTransitionDelegate, UIGestureRecognizerDelegate, IUiUtilExt, WAContactMgrExtension, WAWebViewJSLogicDelegate, UIScrollViewDelegate, YYWebViewDelegate, YYWAWebViewDelegate, WAOrientationSuggestionWindowDelegate>
{
...
- (_Bool)isCurrentPageUnlockOrientationForIphone;
