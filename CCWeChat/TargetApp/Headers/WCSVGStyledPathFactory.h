...
@property(retain, nonatomic) NSNumber *groupOpacityValue; // @synthesize groupOpacityValue=_groupOpacityValue;
...
- (void).cxx_destruct;
- (id)opacityFromAttributes:(id)arg1;
...
- (void)addGroupOpacityValueWithAttributes:(id)arg1;
