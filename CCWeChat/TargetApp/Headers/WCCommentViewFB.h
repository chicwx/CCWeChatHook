...
@class NSMutableSet, NSString, RichTextView, UIButton, UIImageView, UINavigationController, WCUserComment;

@interface WCCommentViewFB : MMUIView <RichTextLayoutDelegate, WCForceTouchTriggerLongPressProtocol, IMMLanguageMgrExt, ILinkEventExt, ITranslateSnsMgrExt>
{
    ...
    NSMutableSet *translateWidthSet;
...
- (void)removeTranslateHeightCache;
