...
@interface MMWebSearchController : NSObject <WSVideoPlayerViewDelegate, WCActionSheetDelegate, UISearchBarDelegate, UISearchDisplayDelegate, UIScrollViewDelegate, WSJSEventHandleDelegate, FTSWebSearchDataSource, WSTagSearchDelegate, WSContactSearchLogicDelegate, WASearchFromGlobalProxyDelegate, WSSuggestionLogicDelegate, WAAppCanvasWrapperViewDelegate, IWSViewControllerLifeCycleExt, CNetworkStatusExt, WAWidgetJSEventHandlerDelegate>
{
