...
@class DrawLotteryResponse, ExposureInfoModifyResponse, GetLotteryResponse, MMWebViewController, NSMutableArray, NSString, WCPayDrawLotteryCgi, WCPayGetLotteryCgi, WCPayJumpRemindControlLogic, WCPayModifyExposureCgi, WCPayOfflineAckMsgCgi, WCPayOfflineCancelPayCgi, WCPayOfflineGetMsgCgi, WCPayOfflinePayConfirmView, WCPayPayMoneyLogic, WCPayRealnameGuideInfo;
