...
@class AddMemLogic, CContact, ChangeOwnerLogic, DelMemLogic, DelaySwitchSettingLogic, MMTableViewInfo, NSArray, NSIndexPath, NSString, NameEditorViewController, RichTextView, UIButton, UIView, ViewMemLogic, WAMsgBrowserDataLogic, WAMsgFastBrowserView;

@interface ChatRoomInfoViewController : MMUIViewController <WAMsgBrowserDataLogicDelegate, tableViewDelegate, ChatRoomMemberGridViewDelegate, MMTableViewInfoDelegate, contactInfoDelegate, IContactMgrExt, IGroupMgrExt, IOpenImOplogExt, UIAlertViewDelegate, WCActionSheetDelegate, IAutoSetRemarkExt, IOplogExt, AddMemLogicDelegate, ViewMemLogicDelegate, DelMemLogicDelegate, ChatRoomManagementDelegate>
{
