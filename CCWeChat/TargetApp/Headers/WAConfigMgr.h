...
@class NSDictionary, NSMutableDictionary, NSString, WAAppBrandNotifyStorage, WAAppBrandRedDotNotifyStorage, WAEnableCopyPathMenuNotifyStorage, WALocationGetter;
...
- (_Bool)isInsertVideoToWebLayer;
- (_Bool)isInsertToWebLayer;
