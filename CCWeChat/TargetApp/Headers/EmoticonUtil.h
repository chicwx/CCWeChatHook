...
+ (void)addAppid:(id)arg1 designerId:(id)arg2 activityId:(id)arg3 thumbImgUrl:(id)arg4 attachedText:(id)arg5 toExtInfo:(id)arg6;
+ (id)extInfoForAppid:(id)arg1 DesignerId:(id)arg2 activityId:(id)arg3 thumbImgUrl:(id)arg4 attachedText:(id)arg5;
