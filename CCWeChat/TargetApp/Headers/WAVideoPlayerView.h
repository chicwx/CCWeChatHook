...
@property(nonatomic) unsigned int initialTimeWait; // @synthesize initialTimeWait=_initialTimeWait;
...
@property(retain, nonatomic) NSString *videoPathWait; // @synthesize videoPathWait=_videoPathWait;
...
- (void)reportVideoAction:(unsigned int)arg1 eventNote:(id)arg2;
