...
@interface NewQRCodeScanner : MMUIView <PBMessageObserverDelegate, UINavigationControllerDelegate, CameraScannerViewDelegate, IUiUtilExt>
{
    _Bool oneDMode;
    _Bool decoding;
    _Bool hasInit;
...
@property(readonly, nonatomic) unsigned int fliterResult; // @synthesize fliterResult=_fliterResult;
...
- (int)pickResulIndexFromFileOriginalResults:(vector_09f8cb62)arg1 touchContext:(id)arg2;
- (int)pickResulIndexFromScanerOriginalResults:(vector_09f8cb62)arg1;
