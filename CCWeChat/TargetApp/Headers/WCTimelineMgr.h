...
@class MyWCDB, NSMutableArray, NSMutableDictionary, NSString, WCAdvertiseDataHelper, WCAdvertiseLogicMgr, WCTimelineControllerStatusMgr, WCTimelineDataProvider;
...
@interface WCTimelineMgr : MMObject <WCDataProviderDelegate>
{
    ...
    WCTimelineControllerStatusMgr *m_vcStatusMgr;
    _Bool isNoMoreData;
...
@property(retain, nonatomic) WCTimelineControllerStatusMgr *m_vcStatusMgr; // @synthesize m_vcStatusMgr;
