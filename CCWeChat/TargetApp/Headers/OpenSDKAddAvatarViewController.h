...
@class MMTableViewCellInfo, MMTableViewInfo, MMTipsViewController, NSString, UIButton, UIImage, WCUITextField;
...
@interface OpenSDKAddAvatarViewController : MMUIViewController <PBMessageObserverDelegate, MMImagePickerManagerDelegate, UITextFieldDelegate>
{
    ...
    MMTableViewCellInfo *_nickNameCellInfo;
...
@property(retain, nonatomic) MMTableViewCellInfo *nickNameCellInfo; // @synthesize nickNameCellInfo=_nickNameCellInfo;
