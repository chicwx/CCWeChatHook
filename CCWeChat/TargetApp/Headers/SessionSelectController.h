...
@class CContact, CreateChatLogic, FavClickStreamHelper, MMUIAlertView, NSMutableArray, NSObject, NSString, NewContactsSearchPanelView, SessionSelectView, UIAlertController;
