...
@class CLLocation, FavClickStreamHelper, LocationRetriever, MMAutoSearchLogic, MMLocationAttributeBanner, MMLocationPinView, MMSearchBar, MMTableView, NSMutableArray, NSString, POIItem, QMapView, UIAlertView, UIButton, UILabel, UIPinchGestureRecognizer, WCTimeLineFooterView;
